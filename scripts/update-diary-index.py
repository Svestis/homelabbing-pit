...
def read_frontmatter(path: Path) -> dict:
    """Read the simple YAML frontmatter fields we need."""
...
def update_readme(index):
    """Replace only the generated section of diary/README.md."""
...
def main():
    ...
    print(f"Updated diary index with {len(entries)} entries.")
